...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:20px;text-align:center;"><center>User Target Report</center></div>
        ...
        <table class="table_cust" style="width: 100%;border-collapse: collapse;">
            ...
            <tr>
                <td style="text-align: left;padding-left:10px"><?php echo e($value['item_code']); ?></td>
                <td style="text-align: left;padding-left:10px"><?php echo e($value['item_name']); ?></td>
                <td style="text-align: left;padding-left:10px"><?php echo e($value['balance']); ?></td>
                <td style="text-align: left;padding-left:10px"><?php echo e($value['available']); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table><br></div></div>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_users_target_report.blade.php ENDPATH**/ ?>