          ...
          <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
           ...
           <div class="carousel-inner" role="listbox">
             ...
             <div class="carousel-item active">
               <img class="d-block w-100" src="<?php echo e(URL::asset('/image/4.jpeg')); ?>"
                 alt="First slide">
             </div>
             <!--/First slide-->
             <!--Second slide-->
             <div class="carousel-item">
               <img class="d-block w-100" src="<?php echo e(URL::asset('/image/5.jpeg')); ?>"
                 alt="First slide">
             </div>
             <!--/Second slide-->
             <!--Third slide-->
             <div class="carousel-item">
               <img class="d-block w-100" src="<?php echo e(URL::asset('/image/2.jpeg')); ?>"
                 alt="First slide">
             </div>
             <!--/Third slide-->
           </div>
    ...
    <section class="price-container" id="sectiona">
      <div class="container" id="scroll-down" >
        <div class="world-most">
            <h2> <?php echo e(__('lang.Feature')); ?> </h2>
          </div>
                    ...
                    <div class="testimonial_inner">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h3 class="text-center text-uppercase mt-2"> <?php echo e(__('lang.Toyota')); ?>  </h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial_box">
                    <div class="testimonial_inner">
                        <div class="media">
                            ...
                            <div class="media-body">
                            <h3 class="text-center text-uppercase mt-2"> <?php echo e(__('lang.lexus')); ?>   </h3>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="row">
               <div class="col-sm-6">
                 <div class="customer-view-image">
                   <img src="<?php echo e(URL::asset('/image/1.jpeg')); ?>" alt="">
                 </div>
               </div>
               <div class="col-sm-6">
                <div class="customer-details-team">
                    <h3><?php echo e(__('lang.team')); ?></h3>
                    <p> <?php echo e(__('lang.about')); ?></p>
                      <div class="row py-2">
                        <div class="col-xs-4 col-sm-4">
                          <div class="customer-stification">
                              ...
                              <p> <?php echo e(__('lang.Satisfaction')); ?> </p>
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4">
                          <div class="customer-stification">
                              ...
                              <p> <?php echo e(__('lang.support')); ?> </p>
                          </div>
                        </div>
                        <div class="col-xs-4 col-sm-4">
                          <div class="customer-stification cutomer-remove-border ">
                              ...
                              <p> <?php echo e(__('lang.Customers')); ?> </p>
                          </div>
                        </div>
                      </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/pages/index.blade.php ENDPATH**/ ?>