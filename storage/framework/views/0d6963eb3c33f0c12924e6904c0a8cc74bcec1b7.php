...
<html>
    <head>
        ...
        <style>
            ...
            /* body {
            background: url(<?php echo e(URL::asset('/challenger2-1.png')); ?>);
    ...
    <hr style="border-top: 1px solid #0C0D0E;">
        <table class="table_cust" style="width: 100%;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td><?php echo e($value['available']); ?></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_inventory.blade.php ENDPATH**/ ?>