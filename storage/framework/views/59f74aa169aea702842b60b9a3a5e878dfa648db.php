                ...
                <div class="header" style="padding-bottom:30px!important; border: none !important;">
                  ...
                  <hr style="border-top: 1px solid #0C0D0E;">
                    <table class="table_cust_total" style="width: 50%;border-collapse: collapse;float:left">
                     <tr>
                          ...
                          <td style="text-align: right;padding-right:10px;"><?php echo e($total_jobs_amount); ?></td>
                     </tr>
                     <tr>
                          <td style="text-align: left;padding-left:10px"><b>Total Expense</b></td>
                          <td style="text-align: right;padding-right:10px;"><?php echo e($total_exp); ?></td>
                     </tr>
                     <tr>
                          <td style="text-align: left;padding-left:10px;border-top:1px solid #808080;font-weight:bold"><b>Net Profit</b></td>
                          <td style="text-align: right;padding-right:10px;border-top:1px solid #808080;font-weight:bold"><?php echo e(($total_jobs_amount - $total_exp)); ?></td>
                     </tr>
                    </table>
                  ...
                  <table class="table_cust" style="width: 100%;border-collapse: collapse;">
                      ...
                      <tr>
                          ...
                          <td><?php echo e($value['acc_num']); ?></td>
                          <td><?php echo e($value['acc_name']); ?></td>
                      ...
                      <tr>
                          ...
                          <td style="border-top:1px solid #0C0D0E;font-weight:bold"><?php echo e($total_exp); ?></td>
                      </tr>
                  ...
                  <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                     <tr style="background-color: #808080;color: Black;">
                      ...
                      <?php $__currentLoopData = $job_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          <td style="width: 50px;"><?php echo e($value['job_card_no']); ?></td>
                      ...
                      <tr>
                          ...
                          <td style="border-top:1px solid #0C0D0E;font-weight:bold"><?php echo e($total_jobs_amount); ?></td>
                      </tr>
                  </table><br>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_all_expense_report.blade.php ENDPATH**/ ?>