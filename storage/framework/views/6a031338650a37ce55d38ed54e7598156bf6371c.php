    ...
    <div style="margin-left:20px;">
          ...
          <tbody>
            <tr>
              ...
              <td style="text-align:right;border: none !important;">
                <b>
                  <h4>شركة شالنجــر للسيــارات</h4>
                </b>
                <b>
                  <h4>CHALLENGERvvv FOR CARS</h4>
                </b>
                <b>
                  <h4>تلفـون: 22277244</h4>
                </b>
              </td>
            </tr>
          </tbody>
      ...
      <table class="table_cust" style="width: 100%;border-collapse: collapse;">
        ...
        <tr>
          ...
          <td>The following reason was given for the refund</td>
        </tr>
      </table>
    </div>
  </div>
