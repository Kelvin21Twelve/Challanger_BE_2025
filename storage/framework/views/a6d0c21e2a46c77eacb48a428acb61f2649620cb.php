...
<html>
    ...
    <body>
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:15px;text-align:center;"><center>Spare Part Without Job Cards Report</center></div>
        <div style="width:100%;margin-bottom: 8px;font-size: 10px;color: black;font-weight: 600;text-align:right;"><span>Date: <?php echo e(date("Y-m-d")); ?></span></div>
        <div style="width:100%;margin-bottom: 8px;font-size: 10px;color: black;font-weight: 600;text-align:right;;"><span>From Date: <?php echo e($from_date); ?></span><span style="float:right;">To Date: <?php echo e($to_date); ?></span></div>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td><?php echo e($value['inv_date']); ?></td>
                <td><?php echo e($value['job_card_no']); ?></td>
                <td><?php echo e($value['customer_used_spare_parts_item_name']); ?></td>
                <td><?php echo e($value['customer_used_spare_parts_price']); ?></td>
                <td><?php echo e($value['customer_used_spare_parts_qty']); ?></td>
                <td><?php echo e($value['customer_used_spare_parts_total']); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table><br>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td><?php echo e($value['inv_date']); ?></td>
                <td><?php echo e($value['job_card_no']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_item']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_item_code']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_price']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_qty']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_discount']); ?></td>
                <td><?php echo e($value['customer_new_spare_parts_total']); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table><br>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_without_job_card.blade.php ENDPATH**/ ?>