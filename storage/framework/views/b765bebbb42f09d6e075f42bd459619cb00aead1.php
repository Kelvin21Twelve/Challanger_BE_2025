...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:15px;text-align:center;">Daily Details Report</div>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td><?php echo e($value['wONo']); ?></td>
                <td><?php echo e($value['employee']); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table><br></div></div>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_daily_details.blade.php ENDPATH**/ ?>