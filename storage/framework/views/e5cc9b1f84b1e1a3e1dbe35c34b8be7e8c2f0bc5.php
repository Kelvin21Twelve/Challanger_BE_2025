...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:20px;text-align:center;">End of Day Report</div>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            ...
            <tr>
                <td><?php echo e($value['shift_date']); ?></td>
                <td><?php echo e($value['user_name']); ?></td>
                <td><?php echo e($value['paymnet_type']); ?></td>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_end_of_day.blade.php ENDPATH**/ ?>