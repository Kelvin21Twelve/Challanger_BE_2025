...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="width:100%;margin-bottom: 8px;font-size: 20px;color: black;font-weight: 600;text-align:right;"><span>Date: <?php echo e(date("Y-m-d")); ?></span></div>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border:1px solid #808080">
           <tr style="background-color: #808080;color: Black;">
            ...
            <?php $__currentLoopData = $user_details1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><b><?php echo e(@$value['Emp_code']); ?></b></td>
                <td><b><?php echo e(@$value['Emp_name']); ?> </b></td>
                <td><b><?php echo e(@$value['basic_salary']); ?></b></td>
                <td><b><?php echo e(@$value['total_addition']); ?></b></td>
                <td><b><?php echo e(@$value['total_absence']); ?></b></td>
                <td><b><?php echo e(@$value['year']); ?></b></td>
                <td><b><?php echo e(@$value['month']); ?></b></td>
            </tr>
        ...
        <table class="table_vacation_balance" style="width: 100%;text-align: center;border:1px solid #808080">
            <tbody>
                   <tr style="background-color: #808080;color: Black;">
                    ...
                    <?php $__currentLoopData = $vac_type1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr style="border-bottom:1px solid #808080">
                            <td><b><?php echo e(@$data['type']); ?></b></td>
                            <td><b><?php echo e(@$data['balance']); ?></b></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_sal_rel_details.blade.php ENDPATH**/ ?>