...
<html>
    ...
    <body>
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
                      ...
                      <tr>
                            <td style="text-align:left;border: none !important;">
                                <div style="width: 150px;height: 89px; background-color:none">
                                    <img src="<?php echo e(env('IMAGE_URL')); ?>" style="max-width: 60%; height:auto" >
                                </div>
                            </td>
        ...
        <div style="width:100%;margin-bottom: 8px;font-size: 10px;color: black;font-weight: 600;text-align:right;">
          <span>From Date: <?php echo e($from_date); ?></span><span style="float:right;">To Date: <?php echo e($to_date); ?></span> </div>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_all_job_card.blade.php ENDPATH**/ ?>