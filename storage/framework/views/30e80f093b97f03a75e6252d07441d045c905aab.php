...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:20px;text-align:center;">Payroll Details Report</div>
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            <tr style="background-color: #808080;">
                <td style="padding: 10px;"><b>Emp Code:</b></td>
                <!-- <td><b>Emp Name</b></td> -->
                <td><b>Payroll</b></td>
                <td><b>Year</b></td>
                <td><b>Month</b></td>
            ...
            <tr>
                <td style="padding: 7px;"><?php echo e($value['civil_id']); ?></td>
...
<?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/report/print_payroll_details.blade.php ENDPATH**/ ?>