                            ...
                            <div class="row">
                                <div class="col-sm-12 py-2">
                                    <div class="section-title text-center">
                                        <h2><?php echo e(__('lang.Contact Us')); ?></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row py-3">
                              <div class="col-xs-12 col-sm-12  col-md-12 col-lg-6 front-home-pricing-plan-all-doezz ">
                                <div class="front-viewcontactus">
                                  <form method="post" action = "<?php echo e(route('coontactus_store')); ?>"  accept-charset="UTF-8" id="contactus">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group">
                                          <label for="usr"><?php echo e(__('lang.Name')); ?></label>
                                          <input type="text" class="form-control" name="name" placeholder="<?php echo e(__('lang.palce_name')); ?>" required/>
                                        </div>
                                        <div class="form-group">
                                          <label for="email"> <?php echo e(__('lang.Email')); ?></label>
                                          <input type="text" class="form-control" name="email" placeholder="<?php echo e(__('lang.palce_email')); ?>" required/>
                                        </div>
                                        <div class="form-group">
                                          <label for="comment"> <?php echo e(__('lang.Message')); ?></label>
                                          <textarea class="form-control" rows="5" name="message" placeholder="<?php echo e(__('lang.palce_message')); ?>" required="required"></textarea>
                                        </div>
                                        <div class="form-group contact-front-send-data">
                                        <button type="button" class="btn btn-primary" onclick="ajaxCommonSumitForm(this)"><?php echo e(__('lang.Send')); ?></button>
                                        </div>
                                      </form>
                                </div>
                              </div>
                                ...
                                <div class="front-viewsecond-divcontactus">
                                  <div class="front-viewsecond-u-divcontactus">
                                    ...
                                    <div class="media-body">
                                      <h4 class="media-heading contect-left-us-ha"><?php echo e(__('lang.Address')); ?></h4>
                                      <p><?php echo e(__('lang.Address_info')); ?></p>
                                    </div>
                                  </div>
                                  <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                      <h4 class="media-heading"><?php echo e(__('lang.Mobile')); ?></h4>
                                  ...
                                  <div class="media">
                                      ...
                                      <div class="media-body">
                                        <h4 class="media-heading"><?php echo e(__('lang.Email')); ?></h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\challenger-app\resources\views/pages/contact-us.blade.php ENDPATH**/ ?>