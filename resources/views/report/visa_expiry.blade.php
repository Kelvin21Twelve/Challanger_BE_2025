...
<html>
    ...
    <body>
        ...
        <h3><center>Vacation Expiry</center></h3>
        ...
        <h4 style="margin-left: 10px;">
             This application is to request a renew of Visa. Your visa is going to expire on the <span>{{$visa_end_date}}</span>. Your visa expires in 2 days, Please renew your visa.
        </h4>
        <h3> Sincerely,</h3>
