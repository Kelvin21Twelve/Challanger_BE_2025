...
<html>
    ...
    <body>
        ...
        <h4 style="margin-left: 10px;">
             This application is for notification of the end of the vacation. Your vacation will end on the <span>{{$vacation_end_date}}</span>. Please attend the office on {{$vacation_resume_date}}.
        </h4>
        <h3> Sincerely,</h3>
