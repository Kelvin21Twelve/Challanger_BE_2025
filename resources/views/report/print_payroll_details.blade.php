...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        {{-- <div style="width:100%;margin-bottom: 8px;font-size: 20px;color: black;font-weight: 600;text-align:right;"><span>From Date: {{$from_date}}</span><span style="float:right;">To Date: {{$to_date}}</span></div> --}}
        ...
        <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            ...
            <tr>
                <td style="padding: 7px;">{{$value['civil_id']}}</td>
                <!-- <td>{{$value['name']}}</td> -->
                <td>{{$value['salary']}}</td>
                <td>{{$value['year']}}</td>
                <td>{{$value['month']}}</td>
