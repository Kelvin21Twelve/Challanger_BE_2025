  ...
  <div class="container">
    <div style="margin-left:20px;">
      ...
      <table style="font-weight: normal; width: 100%;">
        <tr>
          <td>Customer</td>
          <td>{{$main_array['job_card_details']['cust_name']}}</td>
          <td>Invoice No</td>
          <td>{{$main_array['job_card_details']['job_no']}}</td>
        </tr>
        <tr>
          <td>Phone</td>
          <td>{{$main_array['job_card_details']['phone']}}</td>
          <td>Invoice Date</td>
          <td>{{date("Y-m-d")}}</td>
        </tr>
        <tr>
          <td>Plate No</td>
          <td colspan="3">{{$main_array['job_card_details']['plate_no']}}</td>
        </tr>
      </table>
      ...
      <table class="table_cust" style="width: 100%;border-collapse: collapse;">
        ...
        <tr>
          ...
          <td>{{$main_array['job_card_details']['paid']}}</td>
        </tr>
        <tr>
          <td><b>Invoice Amount</b></td>
          <td>{{$main_array['job_card_details']['grand_total']}}</td>
        </tr>
        <tr>
          <td><b>Refund Amount</b></td>
          <td>{{$main_array['job_card_details']['refund_balance']}}</td>
        </tr>
        <tr>
          <td><b>Refund By</b></td>
          <td>{{$main_array['job_card_details']['refund_by']}}</td>
        </tr>
        <tr>
          <td><b>Refund Reason</b></td>
          <td>{{$main_array['job_card_details']['refund_reason']}}</td>
        </tr>
      </table>
    </div>
  </div>
