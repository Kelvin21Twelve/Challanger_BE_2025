            ...
            <div style="margin-left:20px;">
                        <div class="header" style="padding-bottom:30px!important; border: none !important;">
                            <table class="table_header2" width="100%" id="myTable" cellpadding="20" style="padding-bottom: 30px!important;border: none !important;">
                                ...
                                <img src="{{ $main_array['image']}}" style="max-width: 20%; height:auto; margin-top:10px"></div></td>
                ...
                <table class="main_table" style="width: 100%;border-collapse: collapse;text-align: left">
                    <tr>
                        ...
                        <td style="width: 200px;">{{$main_array['job_card_details']['job_no']}}</td>
                        <td colspan="2"><b>Date</b></td>
                        <td colspan="4">{{date("Y-m-d")}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><b>Customer</b></td>
                        <td colspan="">{{$main_array['job_card_details']['cust_name']}}</td>
                        <td colspan="2"><b>Phone</b></td>
                        <td colspan="4">{{$main_array['job_card_details']['phone']}}</td>
                    </tr>
                    <tr>
                        <td><b>Car Type</b></td>
                        <td>{{$main_array['job_card_details']['type']}}</td>
                        <td colspan="2"><b>View</b></td>
                        <td colspan="4">{{$main_array['job_card_details']['view']}}</td>                
                    </tr>
                    <tr>
                        <td><b>Color</b></td>
                        <td>{{$main_array['job_card_details']['color']}}</td>
                        <td colspan="2"><b>Model</b></td>
                        <td colspan="4">{{$main_array['job_card_details']['model']}}</td>
                    </tr>
                    <tr>
                        <td><b>Plate No</b></td>
                        <td>{{$main_array['job_card_details']['plate_no']}}</td>
                        <td colspan="2"><b>Chasis No</b></td>
                        <td colspan="4">{{$main_array['job_card_details']['chasis']}}</td>                
                    </tr>
                    <tr>
                        <td><b>Cab No</b></td>
                        <td>{{$main_array['job_card_details']['cab_no']}}</td>
                        <td colspan="2"><b>Delivery Date</b></td>
                        <td colspan="4">{{$main_array['job_card_details']['delivery_date']}}</td>
                ...
                <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    @foreach($main_array['customer_used_spare_parts'] as $value)
                    <tr>
                    ...
                    <tr>    
                        <td colspan="2"></td>
                        <td><b>Total</b></td>
                        <td>{{$main_array['job_card_calculation']['used_spare_parts_total']}}</td>
                    </tr>
                </table><br>
                <hr style="border-top: 1px solid #0C0D0E;">
                ...
                <table class="table_cust labour_div" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    @foreach($main_array['customer_labours'] as $value)
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><b>Total</b></td>
                        <td><b>{{$main_array['job_card_calculation']['labours_total']}}</b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                ...
                <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    @foreach($main_array['customer_new_spare_parts'] as $value)
                    <tr>
                    ...
                    <tr>
                        <td colspan="4"></td>
                        <td><b>Total</b></td>
                        <td>{{$main_array['job_card_calculation']['new_spare_parts_total']}}</td>
                    </tr>
                </table><br><br>
                <hr style="border-top: 1px solid #0C0D0E;">
                <table style="width: 50%;border-collapse: collapse !important;">
                    ...
                    <td style="width: 25%;text-align:right">{{($main_array['job_card_calculation']['grand_total'])?$main_array['job_card_calculation']['grand_total']:"0.00"}}</td>
                    </tr>
                    <tr>
                    <td style="width: 25%;text-align:left"><b>Paid:</b></td>
                    <td style="width: 25%;text-align:right"><b>{{($main_array['job_card_calculation']['grand_total'] - $main_array['job_card_calculation']['balance'])}}</b></td>
                    </tr> 
                    <tr>
                    <td style="width: 25%;text-align:left"><b>Overdue Amount:</b></td>
                    <td style="width: 25%;text-align:right"><b>{{$main_array['overdue']}}</b></td>
                    </tr>    
                    <tr>
                        <td style="width: 25%;text-align:left"><b>Remain:</b></td>
                        <td style="width: 25%;text-align:right">{{($main_array['job_card_calculation']['balance'])?$main_array['job_card_calculation']['balance']:"0.00"}}</td>
                    </tr>
                </table><br><br>
                ...
                <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    <?php if(isset( $main_array['customer_labours_car_care'] ) ){ ?>
                            @foreach($main_array['customer_labours_car_care'] as $value)
                            <tr>
                                <td>{{$value['price']}}</td>
                                <td>{{$value['quantity']}}</td>
                                <td></td>
                ...
                <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    <?php if(isset( $main_array['customer_labours_workshop'] ) ){ ?>
                            @foreach($main_array['customer_labours_workshop'] as $value)
                            <tr>
                                <td>{{$value['price']}}</td>
                                <td>{{$value['quantity']}}</td>
                                <td></td>
                ...
                <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
                    ...
                    <?php if(isset( $main_array['customer_labours_electrical'] ) ){ ?>
                            @foreach($main_array['customer_labours_electrical'] as $value)
                            <tr>
                                <td>{{$value['price']}}</td>
                                <td>{{$value['quantity']}}</td>
                                <td></td>
