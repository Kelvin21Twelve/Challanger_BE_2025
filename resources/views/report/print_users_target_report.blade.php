    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <table class="table_cust" style="width: 100%;border-collapse: collapse;">
            ...
            <tr>
                <td style="text-align: left;padding-left:10px">{{$value['item_code']}}</td>
                <td style="text-align: left;padding-left:10px">{{$value['item_name']}}</td>
                <td style="text-align: left;padding-left:10px">{{$value['balance']}}</td>
                <td style="text-align: left;padding-left:10px">{{$value['available']}}</td>
            </tr>
            @endforeach
        </table><br></div></div>
    </body>
