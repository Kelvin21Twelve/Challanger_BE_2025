...
<html>
    ...
    <div class="header" style="padding-bottom:30px!important; border: none !important;">
                ...
                <tbody>
                    <tr>
                        <td style="text-align:left;border: none !important;"><div style="width: 150px;height: 89px; background-color:none">
                          <img src="{{env('IMAGE_URL','http://challenger-co.com/challenger2-1.png')}}" style="max-width: 20%; height:auto; margin-top:10px" ></div></td>
        ...
        <div style="width:100%;margin-bottom: 8px;font-size: 20px;color: black;font-weight: 600;"><span>Date: {{date("Y-m-d")}}</span></div>
