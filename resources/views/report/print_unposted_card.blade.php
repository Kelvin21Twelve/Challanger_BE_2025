...
<html>
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:15px;text-align:center;">Unposted Job Cards Report</div>
        ...
        <div style="width:100%;margin-bottom: 8px;font-size: 10px;color: black;font-weight: 600;text-align:right;"><span>From Date: {{$from_date}}</span>
          <span style="float:right;">To Date: {{$to_date}}</span></div>
