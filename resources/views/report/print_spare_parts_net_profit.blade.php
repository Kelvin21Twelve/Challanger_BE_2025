...
<html>
    <head>
        ...
        <!-- <title>Spare Parts Net Profit</title> -->
    ...
    <body>
      ...
      <div class="header" style="padding-bottom:30px!important; border: none !important;">
        ...
        <div style="font-size:15px;text-align:center;">Spare Parts Net Profit Report</div>
        ...
        <div style="width:100%;margin-bottom: 8px;font-size: 10px;color: black;font-weight: 600;text-align:right;">
          ...
          <table class="table_cust" style="width: 100%;text-align: center;border-collapse: collapse;">
            <tr style="background-color: #808080;color: Black;">
                ...
                <td><b>Sales Quantity</b></td>
                <td><b>Sales Total</b></td>
                <td><b>Sales Discount</b></td>
                <td><b>Return Quantity</b></td>
                <td><b>Return Total</b></td>
                <td><b>Return Discount</b></td>
                <td><b>NetProfit</b></td>
            ...
            <tr>
                ...
                <td>{{$value['purchaseQty']}}</td>
                <td>{{$value['purchaseTotal']}}</td>
                <td>{{$value['salesQty']}}</td>
                <td>{{$value['salesTotal']}}</td>
                <td>{{$value['salesDiscount']}}</td>
                <td>{{$value['returnQty']}}</td>
                <td>{{$value['returnTotal']}}</td>
                <td>{{$value['returnDiscount']}}</td>
                <td>{{$value['netProfit']}}</td>
            </tr>
            @endforeach
        </table><br></div></div>
    </body>
